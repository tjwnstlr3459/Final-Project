...
<!-- header 영역 -->
    ...
    <nav>
        ...
        <div class="adminInfoWrap">
            ...
            <div class="adminInfo">
                <span>IU</span><br><!--관리자 닉네임-->
                <span>admin@gmail.com</span><!--관리자 이메일-->
            </div>
        </div>
        <div class="divLine"></div>
        <div class="menuWrap">
            <ul class="menu">
                ...
                <li><a href="/adminInquiryList.do?page=1"><img src="/resources/image/icons/supportAgent_white.png" alt=""><span>문의 / 신고</span></a></li>
